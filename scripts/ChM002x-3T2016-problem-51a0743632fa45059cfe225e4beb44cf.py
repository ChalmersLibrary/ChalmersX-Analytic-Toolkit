...
filenamePrefix = "problem-51a0743632fa45059cfe225e4beb44cf-"
...
class EdxDataEventProcessor:
    ...
    def filter(self, eventData):
        ...
        res = res and eventData["event"]["problem_id"] == "block-v1:ChalmersX+ChM002x+3T2016+type@problem+block@51a0743632fa45059cfe225e4beb44cf"
        return res
